...
describe("Unit tests for deaths", () => {
  const constantsStub = {};
  ...
  it("should test the deaths module", () => {
    const deaths = proxyquire('../src/deaths', {
    ...
    deaths.processData(covidData);        
  });

  it("should test the deaths module including the weekly totals", () => {
    const deaths = proxyquire('../src/deaths', {
      './constants': constantsStub,
      './chartHelper': chartHelperStub,
      './twitterHelper': twitterHelperStub
